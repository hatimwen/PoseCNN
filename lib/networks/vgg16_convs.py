    ...
    def __init__(self, input_format, num_classes, num_units, scales, threshold_label, vote_threshold, vertex_reg_2d=False, vertex_reg_3d=False, pose_reg=False, adaptation=False,
        ...
        if input_format == 'RGBD':
            ...
            if self.vertex_reg:
                ...
                data, gt_label_2d, self.is_train_queue, self.keep_prob_queue, vertex_targets, vertex_weights, poses, extents, meta_data, points, symmetry = q.dequeue()
            ...
            if self.vertex_reg_2d:
                ...
                if self.pose_reg:
                    ...
                    (self.feed('poses_pred', 'poses_target', 'poses_weight', 'points', 'symmetry')
                        .average_distance_loss(margin=0.00, name='loss_pose'))
